...
public class LabRequestController {
    ...
    public TestRequest assignForLabTest(@PathVariable Long id) {
        ...
        try {
            User loggedInUser = userLoggedInService.getLoggedInUser();
            TestRequest testRequest = testRequestUpdateService.assignForLabTest(id,loggedInUser);
    ...
    public TestRequest updateLabTest(@PathVariable Long id, @RequestBody CreateLabResult createLabResult) {
        ...
        try {
            User loggedInUser = userLoggedInService.getLoggedInUser();
            TestRequest testRequest = testRequestUpdateService.updateLabTest(id,createLabResult,loggedInUser);
            return testRequest; // replace this line of code with your implementation
